...
import (
	...
	"github.com/canonical/microcluster/v2/internal/recover"
	internalREST "github.com/canonical/microcluster/v2/internal/rest"
	internalClient "github.com/canonical/microcluster/v2/internal/rest/client"
	"github.com/canonical/microcluster/v2/internal/rest/resources"
...
func (d *Daemon) StartAPI(ctx context.Context, bootstrap bool, initConfig map[string]string, joinAddresses ...string) error {
	...
	cluster, err := d.trustStore.Remotes().ReachableCluster(false, d.ServerCert(), publicKey)
	if err != nil {
		return err
	}
